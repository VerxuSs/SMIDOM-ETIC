...
const WORKFLOWS: WorkflowDef[] = [
  {
    id: "referentiel",
    label: "Référentiel",
    description: "Immatriculation / Fonction",
    fileHint: "Immatriculations.xlsx",
    icon: ClipboardList,
  },
  {
    id: "sytraival",
    label: "Pesées Sytraival",
    description: "Export St Étienne",
    fileHint: "EXPORT_STETIENNE_OM_...xlsx",
    icon: ScaleIcon,
  },
  {
    id: "kilometres",
    label: "Kilomètres",
    description: "Distance par tournée",
    fileHint: "Kilomètres_camions.xlsx",
    icon: MapPinned,
  },
  {
    id: "carburant",
    label: "Carburant",
    description: "Litres consommés",
    fileHint: "Alxlvnet_export_....xlsx",
    icon: Fuel,
  },
  {
    id: "biodechets",
    label: "Bio-déchets",
    description: "Ecovalim (dépivoté)",
    fileHint: "Pesée_Smidom_...xlsx",
    icon: Recycle,
  },
  {
    id: "serfim",
        ...
        <div className="w-full max-w-2xl">
          <div className="flex items-center gap-3 mb-8 justify-center">
            <div className="w-11 h-11 rounded-xl bg-[#0F2A3D] flex items-center justify-center shadow-sm">
              <Truck className="w-6 h-6 text-[#7FD9AE]" strokeWidth={2.2} />
            </div>
            <div>
              <p className="text-[#0F2A3D] text-xl font-extrabold leading-tight">Module Collecte (OM)</p>
              <p className="text-[#52677A] text-xs tracking-wide uppercase">Import des pesées et véhicules</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-[#E1E8E6] shadow-[0_8px_24px_-8px_rgba(15,42,61,0.08)] p-8">
            ...
            <p className="text-[#52677A] text-sm mb-7">
              Choisissez le type de données, le mois de référence, puis déposez le fichier source correspondant.
            </p>

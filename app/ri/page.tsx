...
const WORKFLOWS: WorkflowDef[] = [
  ...
  },
  {
    ...
    description: "Bac, sac, convention",
...
export default function RiUploadPage() {
  ...
  async function handleSubmit() {
    ...
    // Mois auquel rattacher les KPIs calculés (obligatoire côté backend).
      ...
      <div className="w-full max-w-2xl">
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <div>
            ...
            <p className="text-[#52677A] text-xs tracking-wide uppercase">Redevance incitative — snapshots mensuels</p>
          </div>
        </div>

        <div className="bg-white rounded-2xl border border-[#E1E8E6] shadow-[0_8px_24px_-8px_rgba(15,42,61,0.08)] p-8">
          <h1 className="text-[#0F2A3D] text-2xl font-extrabold mb-1">Importer une photographie mensuelle</h1>
          <p className="text-[#52677A] text-sm mb-7">
            Chaque fichier est agrégé à la volée : seuls les compteurs (KPIs) calculés sont enregistrés,
            jamais les lignes brutes.
          </p>
          ...
          <div className="mb-7">
            ...
            <p className="text-[11px] text-[#8AA0AA] mt-1.5">
              Les KPIs calculés sont rattachés à ce mois (upsert : un nouvel import du même mois écrase
              ...
              {fileName ? (
                ...
                <>
                  ...
                  <p className="text-xs text-[#52677A]">
                    ou cliquez pour parcourir — .xlsx, .xls (fichiers volumineux acceptés)
                  </p>
                </>
              )}
            </div>
        ...
        <p className="text-center text-[#9AAAA5] text-xs mt-5">
          Les fichiers sont analysés côté serveur puis seuls les compteurs finaux sont enregistrés en base.
        </p>
      </div>
    </div>
  );
